                        ...
                        <form action="{{route('users.update',$user->id)}}" method = 'post'>
                           ...
                           <div class=" form-text text-danger">{{ $message }}</div>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" id="fname" name="address" class="form-control" value='{{$user->address}}''>
                                @error('address')
                                <div class=" form-text text-danger">{{ $message }}</div>
                                @enderror
                             </div>
                             <div class="mb-3">
                                ...
                                <input type="text" id="fname" name="phone" class="form-control" value= '{{$user->phone}}''>
                                @error('phone')
                             <div class=" form-text text-danger">{{ $message }}</div>
                             @enderror
                             </div>
                             ...
                             <div class="mb-3">
                                ...
                                <input type="text" id="fname" name="birthday" class="form-control" value= '{{$user->birthday}}''>
                                @error('birthday')
                             <div class=" form-text text-danger">{{ $message }}</div>
                             @enderror
                            </div>
